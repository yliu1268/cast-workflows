...
do 
    ...
    zcat chr${chr}_final_SNP_merged_additional_TRs.vcf.gz | java -jar $bref > chr${chr}_final_SNP_merged_additional_TRs.bref3

    echo "Done converting"

    gsutil cp chr${chr}_final_SNP_merged_additional_TRs.bref3 $gcs
